...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    role: Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    course_statuses: Attribute.Relation<
      'plugin::users-permissions.user',
      'oneToMany',
      'api::course-status.course-status'
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiCourseStatusCourseStatus extends Schema.CollectionType {
  ...
  attributes: {
    course: Attribute.Relation<
      ...
      'api::course.course'
    >;
    modules: Attribute.Component<'courses.modules', true>;
    computed_progress: Attribute.Integer;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::course-status.course-status': ApiCourseStatusCourseStatus;
